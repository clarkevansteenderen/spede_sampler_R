...
📌 The [**SPEDE_SAMPLER_DATA**](https://drive.google.com/drive/folders/1IwT4yDOZtkMAMeUpnpovfU2tzsvyUUbU?usp=sharing) file contains all the results of this worked example (i.e. the output of the SPEDE-Sampler R shiny application).
