                ...
                tabsetPanel(
                    ...
                    #sidebarLayout(
                        sidebarPanel(width = 10,
                          ...
                          tags$div(title="Check if you want the results to be reproducible if you run this again with the same data",
                            ...
                            tabPanel(strong("View Data"),
                                     ...
                                     br(), br(),
                                     actionButton('summary_data', label = strong('Show summary table'), style="color: black; background-color: lightblue; border-color: steelblue", icon("edit")),
                            ...
                            tabPanel(strong("Plot Results"), 
                                     ...
                                     br(), 
                                     actionButton("plot_boxplot", label = strong("Plot boxplot"), style="color: black; background-color: lightblue; border-color: steelblue", icon("drafting-compass")), 
                          ...
                          tabPanel(strong("Percentage Matches"),
                                  ...
                                  tags$div(title="View the average, standard deviation, minimum and maximum values for the GMYC data and % matches",
                                    actionButton("view_summary_match_data", label = strong("View Matches Summary"), style="color: black; background-color: lightblue; border-color: steelblue", icon("edit")),
                                    br(), br(),
                                  ),
                          ...
                          tabPanel(strong("Plot Percentage matches"),
                                   ...
                                   br(), br(),
                                   selectInput("plot_matches_type", label = "Select match type: ", choices = c("Including single-sample GMYC species"=1, "Excluding single-sample GMYC species"=2)),
                        ...
                        tabPanel(strong("GMYC Oversplitting"),
                                 br(), br(),
                                 actionButton("GMYC_oversplit_table_view", label = strong("View Summary Table"), style="color: black; background-color: lightblue; border-color: steelblue"),
                                 ...
                                 selectInput("GMYC_barchart_outline", "Barchart outline: ", choices = c("black", "steelblue", "white", "darkgreen"), selected = "black"),
                                 br(), br(),
                    ...
                    tabPanel(strong("Amalgamate"),
                             ...
                             actionButton("view_amalg", strong("View Data"), style="color: black; background-color: lightblue; border-color: steelblue"),
                             downloadButton("download_amalg", strong("Download Data"), style="color: black; background-color: lightblue; border-color: steelblue"),
                             br(), br(),
