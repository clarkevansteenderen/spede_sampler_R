                          ...
                          #                                       "),      
                           ...
                           tabPanel("About",
                                    wellPanel(align = "justify",
                                              ...
                                              HTML("<p align = 'center'><img src = 'GitHub.png' width = '20px' height = 'auto'> <a target='_blank' rel='noopener noreferrer' href='https://github.com/clarkevansteenderen/spede-sampler'> GitHub Link </a></p>"),
                                              ...
                                              br(), br(),
                                              strong("Please cite SPEDE-sampler as: van Steenderen, C.J.M., and Sutton, G.F. 2022. SPEDE-sampler: An R Shiny application to assess how methodological choices and taxon sampling can affect Generalized Mixed Yule Coalescent output and interpretation. Molecular Ecology Resources 20(2). DOI: https://doi.org/10.1111/1755-0998.13591"),
                                              br(), br(),
